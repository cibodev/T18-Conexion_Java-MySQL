...
public class mainApp {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		db.createTable("PiezasDB", "CREATE TABLE Piezas (Codigo INT NOT NULL, Nombre VARCHAR(100), PRIMARY KEY (Codigo));");
		db.createTable("PiezasDB", "CREATE TABLE Proveedores (ID CHAR(4) NOT NULL, Nombre VARCHAR(100), PRIMARY KEY (ID));");
		...
		db.insertData("PiezasDB", "INSERT INTO Suministra (ID, Nombre) VALUES (\"1\", \"1\");");
		db.insertData("PiezasDB", "INSERT INTO Suministra (ID, Nombre) VALUES (\"2\", \"2\");");
		db.insertData("PiezasDB", "INSERT INTO Suministra (ID, Nombre) VALUES (\"3\", \"3\");");
		db.insertData("PiezasDB", "INSERT INTO Suministra (ID, Nombre) VALUES (\"4\", \"4\");");
		db.insertData("PiezasDB", "INSERT INTO Suministra (ID, Nombre) VALUES (\"5\", \"5\");");
		...
		db.getValues("PiezasDB", "Suministra", "DNI", "CodigoPieza", "idProveedor", "Precio");
		db.closeConnection();
	}
